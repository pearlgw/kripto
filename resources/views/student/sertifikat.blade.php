...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Adjust to cover the entire page */
        ...
        .signature {
            position: relative;
            /* Gunakan relative position untuk signature */
            float: right;
            /* Float ke kanan untuk membawa ke pojok kanan */
            margin-top: 30px;
...
<body>
    <div class="certificate">
        ...
        <div class="content">
            Diberikan kepada:<br><br>
            <strong>{{ $user }}</strong><br><br> Sebagai:<br>
        ...
        <div class="signature"> 
            Semarang, {{ \Carbon\Carbon::now()->locale('id_ID')->isoFormat('D MMMM YYYY') }}<br><br> E-Voku Udinus
        </div>
    </div>
</body>
